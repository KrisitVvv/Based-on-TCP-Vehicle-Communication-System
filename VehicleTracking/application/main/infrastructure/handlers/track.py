...
from VehicleTracking.application.main.infrastructure.yolov5.models.common import DetectMultiBackend
from VehicleTracking.application.main.infrastructure.yolov5.utils.datasets import LoadImages, LoadStreams
from VehicleTracking.application.main.infrastructure.yolov5.utils.general import LOGGER, check_img_size, increment_path, non_max_suppression, scale_coords, check_imshow, xyxy2xywh, increment_path
from VehicleTracking.application.main.infrastructure.yolov5.utils.torch_utils import select_device, time_sync
from VehicleTracking.application.main.infrastructure.yolov5.utils.plots import Annotator, colors

from VehicleTracking.application.main.infrastructure.deep_sort_pytorch.utils.parser import get_config
from VehicleTracking.application.main.infrastructure.deep_sort_pytorch.deep_sort import DeepSort
import argparse
import glob

from VehicleTracking.application.main.util.common import  read_yml, extract_xywh_hog
from VehicleTracking.application.main.util.OPT_config import OPT
...
class Yolo5Tracker:
    def __init__(self, config_path:str) -> None:
        ...
        self.cfg = get_config()
        self.cfg.merge_from_file(os.path.abspath(self.opt.config_deepsort))
        self.deepsort = DeepSort(os.path.abspath(self.cfg.DEEPSORT.REID_CKPT),
    ...
    def detect(self, frame_image, frame_idx):
        opt = self.opt
